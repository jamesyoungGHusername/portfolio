    ...
    return (
        <section id="projects">
                <ul className='projectList'>
                    ...
                    <Project image={"https://s3.us-west-2.amazonaws.com/jamesyoung.aws.portfolio/assets/HueIQLogo.jpg"} link='/hue-iq' name="Hue IQ | Color Analysis" desc="A Neural Network Trained To Identify Color Seasons" text="The app allows users to analyze photos of clothes to figure out what color seasons the shades will look best with. The model is a sequential neural network made using the TensorFlow library."/>
                    <Project image={"https://framerusercontent.com/images/DJHjD5SmUc89JSBdK8ehXziRGZk.png?scale-down-to=512"} link='https://upsolve.ai/' name="Upsolve.ai | YC W24" desc="AI Powered Customer Facing Analytics" text={
                        `This project is close to my heart. In Jan of 2024 I was hired by a pair of founders who were about to go through YC to help build their product.
                        Over the course of 6 months I designed and implemented natural language-based user interface elements,
                        allowing customers and account managers to instruct AI to build dashboards
                        with their data; designed and developed a tenancy-based security system to ensure data
                        segregation between different SaaS customers; and developed and implemented FE data visualization components based on
                        customer asks`}/>
                    <Project image={"https://www.getinflow.io/cdn-cgi/image/fit=contain,format=auto,width=null/https://cdn.prod.website-files.com/623a0043a408ef2cbfc81880/6448c5768d7281f771392907_inflow_logo_horizontal_black%201.svg"} link='https://www.getinflow.io/' name="Inflow | YC S21" desc="A Mental Health App For People With ADHD." text="In 2023 I worked as a full-stack developer on the Inflow team."/>
